...
class ERP_class():
    ...
    def plot_topo(self,raw_info,Fs,time=None):
        ...
        mne.viz.plot_topomap(self.mERP[t[1],:], raw_info, axes=ax2, cmap='RdBu_r', show=False) # Visualize topography min
        ax2.set_title('tlag={} ms'.format(int((t[1]/self.srate + self.tmin)*1000)))
